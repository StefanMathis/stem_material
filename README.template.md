...
[`Material`]: https://docs.rs/stem_material/{{VERSION}}/stem_material/material/struct.Material.html
[`FerromagneticPermeability`]: https://docs.rs/stem_material/{{VERSION}}/stem_material/relative_permeability/struct.FerromagneticPermeability.html
